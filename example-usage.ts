...
const species: EtherborneSpecies[] = ['vulmir', 'rendai', 'aqualoth', 'karnathi', 'tharn', 'skellin', 'avenar'];
console.log('🦊 Available Etherborne Species:');
species.forEach(s => console.log(`   - ${s}`));
console.log('');

// Example 2: Working with classes
const classes: HollowGearClass[] = ['arcanist', 'templar', 'tweaker', 'shadehand', 'vanguard', 'artifex', 'mindweaver'];
...
console.log(`   Base: 14, Racial: +2, Total: ${AbilityScoreUtils.calculateTotal(abilityScore)}`);
