...
describe("StartingEquipmentService", () => {
    ...
    const createTestCharacter = (): Character => ({
        ...
        skills: {
            ...
            "Animal Handling": { proficient: false, expertise: false, modifier: 0 },
            ...
            "Sleight of Hand": { proficient: false, expertise: false, modifier: 0 },
            Stealth: { proficient: false, expertise: false, modifier: 0 },
            Survival: { proficient: false, expertise: false, modifier: 0 },
            Tinkering: { proficient: false, expertise: false, modifier: 0 },
        },
        inventory: [],
        mods: [],
