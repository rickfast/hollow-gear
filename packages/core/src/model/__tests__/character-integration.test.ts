 ...
 */
function createMockCharacter(overrides: Partial<HollowGearCharacter> = {}): HollowGearCharacter {
  const baseData = BaseCharacterUtils.createBaseCharacterData("Test Character", "1.0.0");
  ...
  return {
    ...
    level: 1,
    abilities: {
      strength: { base: 10, racial: 0, enhancement: 0, temporary: 0, modifier: 0 },
      dexterity: { base: 14, racial: 0, enhancement: 0, temporary: 0, modifier: 2 },
      constitution: { base: 13, racial: 0, enhancement: 0, temporary: 0, modifier: 1 },
      intelligence: { base: 15, racial: 2, enhancement: 0, temporary: 0, modifier: 3 },
      wisdom: { base: 12, racial: 0, enhancement: 0, temporary: 0, modifier: 1 },
      charisma: { base: 11, racial: 0, enhancement: 0, temporary: 0, modifier: 0 }
    },
    hitPoints: {
      current: 7,
      maximum: 7,
...
describe("Character System Integration", () => {
  describe("Character Data Structure", () => {
    ...
    it("should create a Karnathi Mindweaver with psionic abilities", () => {
      const character = createMockCharacter({
        ...
        abilities: {
          strength: { base: 14, racial: 0, enhancement: 0, temporary: 0, modifier: 2 },
          dexterity: { base: 12, racial: 0, enhancement: 0, temporary: 0, modifier: 1 },
          constitution: { base: 15, racial: 1, enhancement: 0, temporary: 0, modifier: 3 },
          intelligence: { base: 13, racial: 0, enhancement: 0, temporary: 0, modifier: 1 },
          wisdom: { base: 16, racial: 2, enhancement: 0, temporary: 0, modifier: 4 },
          charisma: { base: 10, racial: 0, enhancement: 0, temporary: 0, modifier: 0 }
        },
        psionics: {
    ...
    it("should create a multiclass Templar/Vanguard character", () => {
      const character = createMockCharacter({
        ...
        abilities: {
          strength: { base: 15, racial: 0, enhancement: 0, temporary: 0, modifier: 2 },
          dexterity: { base: 10, racial: 0, enhancement: 0, temporary: 0, modifier: 0 },
          constitution: { base: 14, racial: 0, enhancement: 0, temporary: 0, modifier: 2 },
          intelligence: { base: 12, racial: 0, enhancement: 0, temporary: 0, modifier: 1 },
          wisdom: { base: 16, racial: 1, enhancement: 0, temporary: 0, modifier: 3 },
          charisma: { base: 13, racial: 1, enhancement: 0, temporary: 0, modifier: 2 }
        },
        spellcasting: {
          type: "templar",
          casterLevel: 1,
      ...
      const totalClassLevels = character.classes.reduce((sum, cls) => sum + cls.level, 0);
    ...
    it("should validate character data structure", () => {
      ...
      const invalidCharacter = createMockCharacter({
        ...
        abilities: {
          strength: { base: 25, racial: 0, enhancement: 0, temporary: 0, modifier: 7 }, // Invalid high score
          dexterity: { base: 14, racial: 0, enhancement: 0, temporary: 0, modifier: 2 },
          constitution: { base: 13, racial: 0, enhancement: 0, temporary: 0, modifier: 1 },
          intelligence: { base: 2, racial: 0, enhancement: 0, temporary: 0, modifier: -4 }, // Invalid low score
          wisdom: { base: 12, racial: 0, enhancement: 0, temporary: 0, modifier: 1 },
          charisma: { base: 11, racial: 0, enhancement: 0, temporary: 0, modifier: 0 }
        }
      });
  ...
  describe("Character Serialization and Deserialization", () => {
    ...
    beforeEach(() => {
      testCharacter = createMockCharacter({
        ...
        abilities: {
          strength: { base: 12, racial: 0, enhancement: 0, temporary: 0, modifier: 1 },
          dexterity: { base: 15, racial: 1, enhancement: 0, temporary: 0, modifier: 3 },
          constitution: { base: 14, racial: 0, enhancement: 0, temporary: 0, modifier: 2 },
          intelligence: { base: 16, racial: 2, enhancement: 0, temporary: 0, modifier: 4 },
          wisdom: { base: 10, racial: 0, enhancement: 0, temporary: 0, modifier: 0 },
          charisma: { base: 13, racial: 0, enhancement: 0, temporary: 0, modifier: 1 }
        },
    ...
    it("should serialize and deserialize a character without data loss", async () => {
      ...
      if (serializationResult.success) {
        ...
        const deserializationResult = await SerializationUtils.deserialize(serializedData);
        ...
        if (deserializationResult.success) {
          ...
          // Verify ability scores
          expect(deserializedCharacter.abilities.strength.base).toBe(testCharacter.abilities.strength.base);
          expect(deserializedCharacter.abilities.intelligence.base).toBe(testCharacter.abilities.intelligence.base);
          ...
          expect(deserializedCharacter.classes).toHaveLength(testCharacter.classes.length);
          expect(deserializedCharacter.classes[0].className).toBe(testCharacter.classes[0].className);
          
          // Verify Hollow Gear systems
          expect(deserializedCharacter.heatStress.currentLevel).toBe(testCharacter.heatStress.currentLevel);
          expect(deserializedCharacter.currency.cogs).toBe(testCharacter.currency.cogs);
        }
      }
    });
    ...
    it("should handle serialization with compression", () => {
      ...
      const compressedResult = SerializationUtils.serialize(testCharacter, { compress: true });
      ...
      if (normalResult.success && compressedResult.success) {
        ...
        expect(compressedResult.data.length).toBeLessThan(normalResult.data.length);
    ...
    it("should validate character during deserialization", async () => {
      ...
      const result = await SerializationUtils.deserialize(invalidData, { validate: true });
    ...
    it("should handle deserialization without validation", async () => {
      ...
      const result = await SerializationUtils.deserialize(invalidData, { validate: false });
  ...
  describe("Complex Character Builds", () => {
    it("should handle a high-level multiclass character with all systems", async () => {
      ...
      const character = createMockCharacter({
        ...
        abilities: {
          strength: { base: 10, racial: 0, enhancement: 0, temporary: 0, modifier: 0 },
          dexterity: { base: 14, racial: 0, enhancement: 0, temporary: 0, modifier: 2 },
          constitution: { base: 15, racial: 0, enhancement: 0, temporary: 0, modifier: 2 },
          intelligence: { base: 18, racial: 1, enhancement: 0, temporary: 0, modifier: 4 },
          wisdom: { base: 18, racial: 1, enhancement: 0, temporary: 0, modifier: 4 },
          charisma: { base: 12, racial: 1, enhancement: 0, temporary: 0, modifier: 1 }
        },
      ...
      expect(character.psionics).toBeDefined();
        ...
        if (serializationResult.success) {
          const deserializationResult = await SerializationUtils.deserialize(serializationResult.data);
          expect(deserializationResult.success).toBe(true);
          ...
          if (deserializationResult.success) {
            ...
            expect(deserialized.equipment.mainHand?.modSlots[0].installedMod?.name).toBe("Psionic Amplification Matrix");
          }
        }
    });
    ...
    it("should handle a character with extensive equipment and modifications", async () => {
      const character = createMockCharacter({
        ...
        abilities: {
          strength: { base: 14, racial: 0, enhancement: 0, temporary: 0, modifier: 2 },
          dexterity: { base: 16, racial: 1, enhancement: 0, temporary: 0, modifier: 3 },
          constitution: { base: 15, racial: 0, enhancement: 0, temporary: 0, modifier: 2 },
          intelligence: { base: 18, racial: 2, enhancement: 0, temporary: 0, modifier: 5 },
          wisdom: { base: 12, racial: 0, enhancement: 0, temporary: 0, modifier: 1 },
          charisma: { base: 10, racial: 0, enhancement: 0, temporary: 0, modifier: 0 }
        },
        equipment: {
          ...createMockCharacter().equipment,
          armor: {
          id: "powered-armor-001",
          name: "Relic Powered Plate",
          type: "heavy_armor",
          tier: "relic",
          properties: {
            powered: true,
          ...
          modSlots: [
            {
              ...
              installedMod: {
                ...
                name: "Hydraulic Strength Enhancer",
                tier: 3,
                type: "power",
                effects: [
                  {
                ...
                blueprint: {
                  id: "strength-enhancer-bp",
                  name: "Strength Enhancer Blueprint",
                  materials: []
                }
              }
            },
            {
              ...
              installedMod: {
                ...
                blueprint: {
                  id: "climate-control-bp",
                  name: "Climate Control Blueprint",
                  materials: []
                }
              }
            }
        ...
        const encumbranceStatus = CharacterUtilities.getEncumbranceStatus(character);
        ...
        const summary = CharacterUtilities.createCharacterSummary(character);
        expect(summary.equipment.armor).toBe("Relic Powered Plate");
        ...
        if (serializationResult.success) {
          ...
          if (deserializationResult.success) {
            const deserialized = deserializationResult.data;
            expect(deserialized.equipment.armor?.modSlots).toHaveLength(2);
    ...
    it("should handle character progression and advancement", async () => {
      const character = createMockCharacter({
        ...
        abilities: {
          strength: { base: 16, racial: 1, enhancement: 1, temporary: 0, modifier: 4 }, // +1 from ASI
          dexterity: { base: 12, racial: 0, enhancement: 0, temporary: 0, modifier: 1 },
          constitution: { base: 15, racial: 1, enhancement: 1, temporary: 0, modifier: 3 }, // +1 from ASI
          intelligence: { base: 10, racial: 0, enhancement: 0, temporary: 0, modifier: 0 },
          wisdom: { base: 14, racial: 0, enhancement: 0, temporary: 0, modifier: 2 },
          charisma: { base: 13, racial: 0, enhancement: 0, temporary: 0, modifier: 1 }
        },
      ...
      const totalStrength = character.abilities.strength.base + 
      ...
      const totalConstitution = character.abilities.constitution.base + 
      ...
      expect(totalConstitution).toBe(17); // 15 base + 1 racial + 1 enhancement
        ...
        if (serializationResult.success) {
          ...
          if (deserializationResult.success) {
            const deserialized = deserializationResult.data;
            expect(deserialized.advancement.abilityScoreImprovements).toHaveLength(1);
  ...
  describe("Character Comparison and Utilities", () => {
    ...
    beforeEach(() => {
      ...
      character1 = createMockCharacter({
        ...
        abilities: {
          strength: { base: 10, racial: 0, enhancement: 0, temporary: 0, modifier: 0 },
          dexterity: { base: 16, racial: 0, enhancement: 0, temporary: 0, modifier: 3 },
          constitution: { base: 14, racial: 0, enhancement: 0, temporary: 0, modifier: 2 },
          intelligence: { base: 18, racial: 2, enhancement: 0, temporary: 0, modifier: 5 },
          wisdom: { base: 12, racial: 0, enhancement: 0, temporary: 0, modifier: 1 },
          charisma: { base: 13, racial: 0, enhancement: 0, temporary: 0, modifier: 1 }
      ...
      character2 = createMockCharacter({
        ...
        abilities: {
          strength: { base: 16, racial: 1, enhancement: 0, temporary: 0, modifier: 3 },
          dexterity: { base: 12, racial: 0, enhancement: 0, temporary: 0, modifier: 1 },
          constitution: { base: 15, racial: 1, enhancement: 0, temporary: 0, modifier: 3 },
          intelligence: { base: 10, racial: 0, enhancement: 0, temporary: 0, modifier: 0 },
          wisdom: { base: 14, racial: 2, enhancement: 0, temporary: 0, modifier: 3 },
          charisma: { base: 13, racial: 0, enhancement: 0, temporary: 0, modifier: 1 }
        },
        spellcasting: undefined
      });
    ...
    it("should compare two different characters", () => {
      const comparison = CharacterUtilities.compareCharacters(character1, character2);
    ...
    it("should create character diff for tracking changes", () => {
      ...
      const diff = CharacterUtilities.createCharacterDiff(character1, modifiedCharacter);
      ...
      const currencyChange = diff.changes.find(c => c.field.includes("currency"));
    ...
    it("should calculate derived statistics correctly", () => {
      ...
      expect(stats1.abilityModifiers.intelligence).toBeGreaterThan(stats2.abilityModifiers.intelligence);
      expect(stats2.abilityModifiers.strength).toBeGreaterThan(stats1.abilityModifiers.strength);
    ...
    it("should create comprehensive character summaries", () => {
      ...
      // Verify abilities
      expect(summary1.abilities.intelligence.modifier).toBeGreaterThan(summary2.abilities.intelligence.modifier);
      expect(summary2.abilities.strength.modifier).toBeGreaterThan(summary1.abilities.strength.modifier);
  ...
  describe("Error Handling and Edge Cases", () => {
    ...
    it("should handle missing required character fields", async () => {
      ...
      const result = await SerializationUtils.deserialize(incompleteData, { validate: true });
      expect(result.success).toBe(false);
    ...
    it("should handle extreme ability score values", () => {
      ...
      const strModifier = CharacterUtilities.getTotalAbilityModifier(character, "strength");
      const dexModifier = CharacterUtilities.getTotalAbilityModifier(character, "dexterity");
