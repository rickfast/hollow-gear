...
export const AQUALOTH_TRAITS: SpeciesTraits = {
  ...
  specialAbilities: [
    ...
    },
    {
      ...
      description: 'You have advantage on History checks involving ruins or ancient machinery.',
      mechanics: {
        bonus: {
          type: 'advantage',
          applies_to: ['History checks (ruins)', 'History checks (ancient machinery)']
        }
      }
    },
    {
      ...
      description: 'Once per short rest, when you take psychic or lightning damage, reduce it by your proficiency bonus.',
      usage: {
        rechargeType: 'short',
        usesPerRecharge: 1
      },
      mechanics: {
        bonus: {
          type: 'flat',
          applies_to: ['psychic damage reduction', 'lightning damage reduction']
        }
      }
    }
  ],
  ...
  specialAbilities: [
    {
      ...
      description: 'You can take the Disengage or Hide action as a bonus action once per short rest.',
      usage: {
        rechargeType: 'short',
        usesPerRecharge: 1
      },
    ...
    },
    {
      id: 'echo_mimicry',
      name: 'Echo Mimicry',
      description: 'You can reproduce any sound or voice you\'ve heard for up to 6 seconds (Deception check contested by Insight).',
      mechanics: {
        bonus: {
          type: 'advantage',
    ...
    },
    {
      id: 'shadow_step',
      name: 'Shadow Step',
      description: 'When you move from dim light to dim light, you can teleport up to 10 ft (once per long rest).',
      usage: {
        rechargeType: 'long',
        usesPerRecharge: 1
      },
  ...
  specialAbilities: [
    {
      ...
      description: 'You gain proficiency with Tinker\'s Tools. If already proficient, double your proficiency bonus.',
      mechanics: {
        bonus: {
          type: 'proficiency',
    ...
    },
    {
      id: 'jury_rig',
      name: 'Jury-Rig',
      description: 'Once per short rest, repair or improvise an item to restore 1d8 HP to a construct or mechanical device.',
      usage: {
        rechargeType: 'short',
        usesPerRecharge: 1
      },
    ...
    },
    {
      id: 'overclocker',
      name: 'Overclocker',
      description: 'When you roll a 1 on a weapon damage die for a modded weapon, you may reroll once.',
      mechanics: {
        bonus: {
          type: 'advantage',
...
export const KARNATHI_TRAITS: SpeciesTraits = {
  ...
  speed: {
    ...
    climb: 20,
    fly: 0,
    restrictions: ['Can climb difficult surfaces including vertical stone without a check up to 20 ft']
  },
  specialAbilities: [
    {
      id: 'iron_resolve',
      ...
      mechanics: {
        bonus: {
          type: 'advantage',
          applies_to: ['saving throws vs frightened', 'saving throws vs charmed']
        }
      }
    },
    {
      ...
      description: 'Once per long rest, add +1d4 to any saving throw or attack roll after seeing the result.',
      usage: {
        rechargeType: 'long',
        usesPerRecharge: 1
      },
    ...
    },
    {
      id: 'climbers_gait',
      name: 'Climber\'s Gait',
      description: 'You can climb difficult surfaces, including vertical stone, without a check up to 20 ft.',
      mechanics: {
        bonus: {
          type: 'advantage',
  ...
  specialAbilities: [
    {
      id: 'charge',
      name: 'Charge',
      description: 'If you move at least 20 ft straight toward a creature before hitting with a melee attack, add +1d6 damage.',
      mechanics: {
        damage: {
          dice: 'd6',
          count: 1,
    ...
    },
    {
      id: 'aether_linked',
      name: 'Aether-Linked',
      description: 'Once per long rest, when you drop to 0 HP, you instead drop to 1 HP and emit a psionic pulse (5-ft radius, push 10 ft).',
      usage: {
        rechargeType: 'long',
        usesPerRecharge: 1
      },
    ...
    },
    {
      id: 'natures_kin',
      name: 'Nature\'s Kin',
      description: 'You have advantage on Survival checks to track, forage, or navigate in wilderness or ruin.',
      mechanics: {
        bonus: {
          type: 'advantage',
          applies_to: ['Survival (tracking)', 'Survival (foraging)', 'Survival (navigation)']
        }
      }
    }
  ],
...
export const SKELLIN_TRAITS: SpeciesTraits = {
  ...
  specialAbilities: [
    ...
    },
    {
      ...
      description: 'As a bonus action, blend with surroundings to gain advantage on Stealth checks until you move.',
      mechanics: {
        bonus: {
          type: 'advantage',
    ...
    },
    {
      id: 'sticky_grip',
      name: 'Sticky Grip',
      description: 'Advantage on checks or saves to avoid being disarmed or knocked prone.',
      mechanics: {
        bonus: {
          type: 'advantage',
...
export const AVENAR_TRAITS: SpeciesTraits = {
  ...
  specialAbilities: [
    {
      id: 'aether_recall',
      name: 'Aether Recall',
      description: 'You can perfectly recall any text, sound, or symbol you\'ve encountered within the last week.',
      mechanics: {
        bonus: {
          type: 'advantage',
    ...
    },
    {
      id: 'resonant_logic',
      name: 'Resonant Logic',
      description: 'Once per short rest, when you fail an Intelligence or Wisdom check, you may reroll it. You must use the new result.',
      usage: {
        rechargeType: 'short',
        usesPerRecharge: 1
      },
    ...
    },
    {
      ...
      description: 'As a bonus action, you can analyze a creature or device within 30 ft. You learn one of the following (your choice): its AC, HP range (low/medium/high), or whether it has psionic capacity.',
      mechanics: {
        range: {
          type: 'ranged',
          distance: 30
    ...
    },
    {
      ...
      description: 'You can fall up to 60 feet without taking damage, and you always land on your feet.',
      mechanics: {
        bonus: {
          type: 'advantage',
  ...
  etherborneTraits: SpeciesTraitsUtils.createEtherborneTraits(),
  description: {
    appearance: 'Tall, sleek birdfolk with metallic feathers that shimmer from black to silver-blue under light. Their faces are framed by intricate beak-guards or data-filigree masks.',
    culture: 'Matriarchal and consensus-driven, governed by "choirs" — councils of thinkers who harmonize thought until unity is reached.',
...
export namespace SpeciesDataUtils {
   ...
   */
  export function isValidSpecies(species: string): species is EtherborneSpecies {
   ...
   */
  export function getSpeciesByAbilityIncrease(ability: string): EtherborneSpecies[] {
    return getAllSpecies().filter(species => {
      const traits = getSpeciesTraits(species);
      return traits.abilityScoreIncrease.some(increase => increase.ability === ability);
    });
  }
   ...
   */
  export function getSpeciesByMovement(movementType: 'walk' | 'swim' | 'climb' | 'fly'): EtherborneSpecies[] {
    return getAllSpecies().filter(species => {
      const traits = getSpeciesTraits(species);
   ...
   */
  export function getSpeciesByLanguage(language: Language): EtherborneSpecies[] {
    return getAllSpecies().filter(species => {
      const traits = getSpeciesTraits(species);
